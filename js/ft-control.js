        ...
        $(document).on("click", "a[href*='#submit']", async function () {
            ...
            //FlxiFunnel Form code
                ...
                if (goNext) {
                    ...
                    var redValEmail = $dataObject["email"];
                    var redValName = typeof $dataObject["name"] != "undefined" && $dataObject["name"] != "" ? $dataObject["name"] : $dataObject["first_name"];
                    if (typeof redValEmail != "undefined" && redValEmail != "" && ["", "true"].includes(goParams)) {

                        params.append("ff_email", redValEmail);
                        console.log(params);
                        // console.log(goNext);
                        // goNext = goNext+ params;
                        if (params.toString()) {
                            goNext =
                                goNext.split("?")[0] + "?" + params.toString();
                        }
                    ...
                    if (typeof redValName != "undefined" && redValName != "" && ["", "true"].includes(goParams)) {

                        params.append("ff_name", redValName);
                        if (params.toString()) {
                            goNext =
                                goNext.split("?")[0] + "?" + params.toString();
                        }
